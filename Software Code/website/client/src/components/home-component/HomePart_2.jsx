...
const HomePart_2 = () => {
  return (
    <div className="max-auto flex flex-col-reverse gap-y-6 500b:gap-y-10 900b:gap-y-0 900b:flex-row 900b:gap-x-12 1100b:gap-x-14 1700b:gap-x-20 font-inter px-8 400b:px-12 600b:px-18 my-40 1600b:mx-20 2000b:mx-40 2000b:mt-60" id="about">
